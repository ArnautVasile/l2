...
const PORT = 3002;  // schimbă la 3002 pentru server2
...
app.get('/data', async (req, res) => {
    console.log(`Request received on ${req.hostname} - Path: ${req.path} - IP: ${req.ip}`);
    console.log("Request received on Server 2");  // Log pentru identificarea serverului
    const key = 'data';
